...
<html>
	...
	<div class="container-fluid" id="main_cont">
			...
			<div class= "row">
				<div class="container" >
					<div class="col-md-12 center-block text-center">
						<hr>
						<br><br><br><br>
						<h3 id="sorry" ><strong>Sorry for the inconvenience- The Page you are looking does not exist</strong></h3>
						<h3>Seems like you tried to write or modify the URL. Use only the navigation links provided on the webpage</h3>
					</div>
				</div>
			</div>
			<br><br><br>
			<div class= "row">
				<div class="container" >
					<div class="col-md-5 center-block text-center"></div>
							...
							<div class="col-md-5 center-block text-center"></div><br><br>
							<br><br>
