	...
	public String sendWelcomeMail(String name, String email) {
		...
		Session session = Session.getDefaultInstance(properties,new javax.mail.Authenticator() {
																	protected PasswordAuthentication getPasswordAuthentication() {
																		return new PasswordAuthentication("rishi.prabhat97@gmail.com","XXXXXXXXXX");
																	}
																});
		try {
			//COMPOSE MESSAGE
			...
			String msg ="<body bgcolor='#DAF7A6'>Hey <i><font color='#FF7A33'>" + name + "</font></i>,<br/><br/>" +
			...
			DataSource fds = new FileDataSource("E:\\Trainee Engineers March 2019\\workspace\\TrainingProject_Rishi\\WebContent\\images/logo.png");
			mbp1.setDataHandler(new DataHandler(fds));
			mbp1.setHeader("Content-ID", "<image>");
			mp.addBodyPart(mbp1);
			
			mbp1 = new MimeBodyPart();
			fds = new FileDataSource("E:\\Trainee Engineers March 2019\\workspace\\TrainingProject_Rishi\\WebContent\\images/mailer.jpg");
			mbp1.setDataHandler(new DataHandler(fds));
